...
class JudgeProfile(models.Model):
    ...
    profile_picture = models.ImageField(upload_to="judges_profile_picture.png", default="profile.png")
...
class JudgesPoll(models.Model):
    ...
    voted_participant = models.ForeignKey(ParticipantPolls, on_delete=models.CASCADE, null=True, blank=True, editable=False)
